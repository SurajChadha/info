...
//	    ArrayList<Postal Address> postalAddresses= newArrayList<>();
...
public class Contacts {
    ...
    public static void main(String[] args) {
        Map<String, String> phonebook = new HashMap<>(); // create a hash map to store phonebook entries
        ...
        while (true) {
            ...
            phonebook.put(name, phoneNumber); // add entry to the phonebook
